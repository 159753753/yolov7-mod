...
def parseJsonFile(json_path, txt_save_path):
    ...
    for imgId in tqdm(imgIds):
        ...
        for ann in anns:
            ...
            w = bbox[2]
            h = bbox[3]
            # obj = [ann['category_id'], xc, yc, w, h]  # coco2017数据集共80小类，类别id号不连续，最大为90
            obj = [id_map[ann["category_id"]], xc, yc, w, h]
            objs.append(obj)
        info['objects'] = objs
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        json_path = 'P:/Dataset_COCO/annotations/instances_train2017.json'  # r'D:\practice\compete\goodsDec\data\train\train.json'
        txt_save_path = 'P:/Dataset_COCO/train_convert2yolo'
