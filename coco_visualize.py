...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        image_path = 'P:/Dataset_COCO/images/train2017'
        anno_path = 'P:/Dataset_COCO/annotations/instances_train2017.json'
        show_image(image_path, anno_path, show=False, plot_image=True)
        print(every_class_num)
        print("category nums: {}".format(len(category_set)))
        print("image nums: {}".format(len(image_set)))
        print("bbox nums: {}".format(sum(every_class_num.values())))
