...
from utils.attention_biformer import *
...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in [nn.Conv2d, Conv, RobustConv, RobustConv2, DWConv, GhostConv, RepConv, RepConv_OREPA, DownC,
                 ...
                 Conv_Att_GAM, Conv_Att_CA, Conv_Att_BitF, SAConv2d,
                 CBAMBlock, GAMAttention, EMAattention]:
            c1, c2 = ch[f], args[0]
            ...
            if m in [DownC, SPPCSPC, GhostSPPCSPC,
                     ...
                     ST2CSPA, ST2CSPB, ST2CSPC, C3, C2f]:
                args.insert(2, n)  # number of repeats
                n = 1
        # Coordinate attention start
        elif m in [CoordinateAttention]:
            c1, c2 = ch[f], args[0]
        ...
        # concat attention CA start
        elif m is Concat_Att_CA:
            c2 = sum([ch[x] for x in f])
            args = [c2, *args]
        # concat attention CA end
        elif m is Chuncat:
            c2 = sum([ch[x] for x in f])
        elif m is Shortcut:
            c2 = ch[f[0]]
